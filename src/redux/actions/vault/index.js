import {SET_AVAILABLE_YAI, SET_ALLOWANCE_YAI, SET_YAI_VAULT_DAW_BALANCE, SET_YAI_AMOUNT, SET_YAI_REWARDS, HANDLE_LOADING, SET_DSWAP_BALANCE} from '@redux/types';
import BigNumber from 'bignumber.js';
import {YAIVaultDawBalance, YAIVaultUserInfo, YAIAllowance, YAIApprove, YAIBalanceOfAddress, YAIVaultDeposit, YAIVaultWithdraw, PendingRewards} from '@contractMethods/Vault'
import {showToastMessage} from '@redux/actions/toastNotification';

// src/utility/contractMethods/Vault.js
export const fetchVaultData = (address) => async dispatch => {
    try {
        if(address){
            ...
            console.log('YAIVaultDawBalanceRes: ', YAIVaultDawBalanceRes);
            console.log('new BigNumber(YAIVaultDawBalanceRes).div(1e18): ', new BigNumber(YAIVaultDawBalanceRes).div(1e18).toString());
            dispatch({
